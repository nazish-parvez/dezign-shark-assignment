...
const Mission = () => {
  return (
    <section className="px-12 md:px-16 lg:px-30 py-12 bg-white font-spaceGrotesk">
      {/* Top small title */}
      <div className="text-center mb-4 text-sm lg:text-lg font-normal font-spaceGrotesk">
      ...
      {/* Main Heading */}
      <h2 className="text-center text-3xl md:text-5xl font-bold text-gray-900 mb-6">
      ...
      <div className="relative flex flex-col lg:flex-row items-center justify-center gap-8">
        {/* Yellow badge */}
        <div className="absolute -left-7 top-10 lg:-left-16 lg:top-12 z-10">
        ...
        <img
          src={groupImg}
          alt="Team working"
          className="w-full h-36 lg:h-auto lg:w-[150rem] rounded-lg shadow-lg"
        />
      </div>
    </section>
  );
